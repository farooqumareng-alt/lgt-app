      ...
      <div className="mt-10 grid gap-8 sm:grid-cols-[1.3fr_1fr]">
        ...
        <section>
          ...
          <Card className="mt-4 p-5">
            ...
            />
            <p className="mt-1 text-xs text-ink/70">{wholesalePct}% of this month&apos;s revenue is wholesale</p>
          ...
          <Card className="mt-4 p-5">
            ...
            {stats.lowStockProducts.length > 0 && <LowStockChart items={stats.lowStockProducts.slice(0, 6)} />}
